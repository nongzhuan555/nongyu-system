...
export const DEFAULT_LAYOUTS: Record<GridBreakpoint, GridItemLayout[]> = {
  lg: [
    ...
    chart("chart-settings", 0, 15, 6, 5),
    chart("chart-perf", 6, 15, 6, 5),
    table("table-crashes", 0, 20, 12, 5),
  ],
  md: [
    ...
    chart("chart-settings", 0, 26, 8, 5),
    chart("chart-perf", 0, 31, 8, 5),
    table("table-crashes", 0, 36, 8, 5),
  ],
  xs: [
    kpi("kpi-total-users", 0, 0, 4),
    kpi("kpi-dau", 0, 2, 4),
    ...
    chart("chart-settings", 0, 38, 4, 5),
    chart("chart-perf", 0, 43, 4, 5),
    table("table-crashes", 0, 48, 4, 5),
  ],
};
