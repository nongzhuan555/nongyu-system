...
export const DEFAULT_LAYOUTS: Record<GridBreakpoint, GridItemLayout[]> = {
  ...
  md: [
    ...
    chart("chart-campus", 4, 10, 4, 4),
    chart("chart-grade", 0, 14, 4, 4),
    chart("chart-device", 4, 14, 4, 4),
    chart("chart-college", 0, 18, 8, 5),
    chart("chart-screen-views", 0, 23, 8, 5),
    chart("chart-screen-dwell", 0, 28, 8, 5),
    chart("chart-settings", 0, 33, 8, 5),
  ...
  xs: [
    ...
    chart("chart-campus", 0, 18, 4, 4),
    chart("chart-grade", 0, 22, 4, 4),
    chart("chart-device", 0, 26, 4, 4),
    chart("chart-college", 0, 30, 4, 5),
    chart("chart-screen-views", 0, 35, 4, 5),
    chart("chart-screen-dwell", 0, 40, 4, 5),
    chart("chart-settings", 0, 45, 4, 5),
    chart("chart-button-clicks", 0, 50, 4, 5),
    chart("chart-perf", 0, 55, 4, 5),
    chart("chart-web-vitals", 0, 60, 4, 7),
    table("table-crashes", 0, 67, 4, 5),
  ],
};
